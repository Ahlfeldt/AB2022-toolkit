...
**Stata ado programme**: To install the ado file in Stata, just type 'ssc install AB2022'. In case Stata cannot connect to the internet, you may also copy both files to your ado folder. The programme will be ready to use. For information on the syntax, type 'help AB2022'.
